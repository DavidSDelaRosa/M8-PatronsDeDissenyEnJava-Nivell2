			...
			case 2:
				...
				for(Video v: videosForUser) {
					...
					if(v.checkVideoStatus(actualDate)<15000) {
						JOptionPane.showMessageDialog(null, "Tu video: " +v.getTittle()+" se está subiendo", "YOUR VIDEOS",
								JOptionPane.INFORMATION_MESSAGE);
						
					}else if(v.checkVideoStatus(actualDate)<30000) {
						System.out.println("El vídeo se está verificando");
						JOptionPane.showMessageDialog(null, "Tu video: " +v.getTittle()+" se está verificando", "YOUR VIDEOS",
								JOptionPane.INFORMATION_MESSAGE);
					}else {
